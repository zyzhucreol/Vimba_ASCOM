...
//
// ASCOM Camera driver for AVTVimbaX
//
...
namespace ASCOM.AVTVimbaX.Camera
{
    ...
    //
    // Your driver's DeviceID is ASCOM.AVTVimbaX.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.AVTVimbaX.Camera
    // The COM ClassInterface/None attribute prevents an empty interface called _AVTVimbaX from being created and used as the [default] interface
    //
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AVTVimbaX"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Camera()
        {
            try
            {
                ...
                tl = new TraceLogger("", "AVTVimbaX.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
