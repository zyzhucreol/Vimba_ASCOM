...
1. Look at sample standalone projects vmb_test_loop for N-frame acquisition with event handler (not very helpful) and vmb_test_stream for single frame acquisition.
