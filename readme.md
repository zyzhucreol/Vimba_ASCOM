...
1. Look at sample standalone projects vmb_test_loop for N-frame acquisition with event handler and vmb_test_stream for single frame acquisition.
...
5. Final working version of the ASCOM driver: vmb_ascom7