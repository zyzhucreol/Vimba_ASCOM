...
//
// ASCOM Camera driver for ZZVimbaX
//
...
namespace ASCOM.ZZVimbaX.Camera
{
    ...
    //
    // Your driver's DeviceID is ASCOM.ZZVimbaX.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.ZZVimbaX.Camera
    // The COM ClassInterface/None attribute prevents an empty interface called _ZZVimbaX from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("b9704ab2-1af3-4f35-9987-081c42fa4e6b")]
    [ProgId("ASCOM.ZZVimbaX.Camera")]
    [ServedClassName("ZZVimbaX ASCOM")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZZVimbaX"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Camera()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ZZVimbaX.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.ZZVimbaX.Camera", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
